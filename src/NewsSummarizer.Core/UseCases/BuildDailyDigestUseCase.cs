...
public sealed class BuildDailyDigestUseCase
{
    ...
    public BuildDailyDigestUseCase(
    ...
    public async Task<BuildDailyDigestSummary> ExecuteAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        foreach (var user in users)
        {
            ...
            if (preferences is null || !preferences.DailyDigestEnabled)
            {
            ...
            var digestItems = selectedItems
                .Select((item, index) => new DigestItem
                {
                    ...
                    ReasonSnapshot = item.AiResult.Reason,
        ...
        return new BuildDailyDigestSummary(
            usersChecked,
            digestsCreated,
            usersSkippedDisabled,
            usersSkippedExistingDigest,
    ...
    private static IEnumerable<SelectedDailyDigestItem> SelectItems(
        ...
        UserPreferences preferences)
    {
        foreach (var article in articles)
        {
            ...
            if (!aiResult.DailyDigestCandidate)
            {
                continue;
            }
            ...
            yield return new SelectedDailyDigestItem(article, aiResult);
        }
    }
    ...
    private sealed record SelectedDailyDigestItem(
        NewsArticle Article,
