...
## Роль AI в архитектуре

Bез AI сервис был бы RSS-агрегатором. AI даёт:

- структурированные признаки по каждой новости;
- оценку важности и срочности;
- объяснение, почему новость релевантна пользователю;
- поиск смысловых дублей через embeddings;
- подробный разбор новости по запросу.
